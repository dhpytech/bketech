VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} A0CalendarUF 
   Caption         =   "Select Date"
   ClientHeight    =   3324
   ClientLeft      =   -300
   ClientTop       =   -915
   ClientWidth     =   2700
   OleObjectBlob   =   "A0CalendarUF.frx":0000
End
Attribute VB_Name = "A0CalendarUF"
...
Public Function GetDate(Optional SelectedDate As Date = 0, _
    ...
    Optional leftF As Long) As Date
...
Dim UFleft As Integer
Me.StartUpPosition = 0
Me.Top = Application.Height * getYmouse() / ShowScreenYDimensions()
UFleft = Application.Width * getXmouse() / ShowScreenXDimensions()
  If UFleft > Application.Width - Me.Width Then
